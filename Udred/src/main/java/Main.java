...
import main.java.uniLOADERS.RainbowController;
import main.java.uniLOADERS.RainbowController2;
import main.java.uniLOADERS.RainbowController3;
...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        Window.setTitle("Sensum main");
//        primaryStage.getIcons().add(new Image(File.pathSeparator+"main"+File.pathSeparator+"EG.png"));
        Window.getIcons().add(new Image(getClass().getResource("/images/EG.png").toExternalForm()));
        ...
        Admin.setTitle("Sensum main - Admin");
//        primaryStage.getIcons().add(new Image(File.pathSeparator+"main"+File.pathSeparator+"EG.png"));
        Admin.getIcons().add(new Image(getClass().getResource("/images/EG.png").toExternalForm()));
        ...
        Login.setTitle("Sensum main - Log Ind");
//        primaryStage.getIcons().add(new Image(File.pathSeparator+"main"+File.pathSeparator+"EG.png"));
        Login.getIcons().add(new Image(getClass().getResource("/images/EG.png").toExternalForm()));
